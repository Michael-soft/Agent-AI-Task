...
| 3 | `03-edgeless-diagnostics.png`, `03-edgeless-diagnostics-2.png` … `-6.png` | **Diagnostics** tab — the edgeless `Command(goto)` hop trace (`initial_ingest_node → … → synthesis_node`) plus rendered trend charts. |
